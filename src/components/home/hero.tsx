...
export default function Hero() {
  ...
  const shadowColor = resolvedTheme === "dark" ? "black" : "white";
  ...
  return (
    <>
      <section className="relative overflow-hidden min-h-[calc(100dvh-160px)] flex flex-col">
        <div className="absolute bottom-[12%] flex items-center justify-center w-full z-0">
          <Suspense
            fallback={
          ...
          <div className="mx-auto max-w-4xl text-center flex-1 flex flex-col justify-center">
            ...
            >
              ...
              >
                ...
                {"     "}
                <span className="ml-3">
                  Token Trading with Escrow Protection
                </span>
              </div>
            </motion.div>
            ...
            >
              Our automated smart contract ensures every transaction is safe,
            ...
            >
              ...
              <div className="flex items-center justify-center">
                <a href="https://app.pretgemarket.xyz/" target="_blank">
          ...
          >
            <div className="text-center">
              ...
              <div className="flex items-center justify-center gap-8 flex-wrap">
                ...
                <div className="opacity-60 grayscale hover:opacity-100 hover:grayscale-0 hover:drop-shadow-[0_0_8px_rgba(98,126,234,0.5)] transition-all duration-300">
                  <svg
                    width="32"
                    height="32"
                    viewBox="0 0 256 417"
                ...
                <div className="opacity-60 grayscale hover:opacity-100 hover:grayscale-0 hover:drop-shadow-[0_0_8px_rgba(220,31,255,0.5)] transition-all duration-300">
                  <svg
                    width="32"
                    height="32"
                ...
                <div className="opacity-60 grayscale hover:opacity-100 hover:grayscale-0 hover:drop-shadow-[0_0_8px_rgba(0,82,255,0.5)] transition-all duration-300">
                  <div className="h-8 w-8 rounded-full bg-blue-600 flex items-center justify-center">
                    <span className="text-white font-bold text-sm">B</span>
                  </div>
                </div>

                <div className="opacity-60 grayscale hover:opacity-100 hover:grayscale-0 hover:drop-shadow-[0_0_8px_rgba(243,186,47,0.5)] transition-all duration-300">
                  <div className="h-8 w-8 rounded-full bg-yellow-500 flex items-center justify-center">
                    <span className="text-black font-bold text-sm">B</span>
                  </div>
                </div>

                <div className="opacity-60 grayscale hover:opacity-100 hover:grayscale-0 hover:drop-shadow-[0_0_8px_rgba(40,160,240,0.5)] transition-all duration-300">
                  <svg
                    width="32"
                    height="32"
                  ...
                  >
                    <path
                      d="M141.73 0C63.53 0 0 63.53 0 141.73s63.53 141.73 141.73 141.73 141.73-63.53 141.73-141.73S219.93 0 141.73 0zm0 267.56c-69.36 0-125.83-56.47-125.83-125.83S72.37 15.9 141.73 15.9s125.83 56.47 125.83 125.83-56.47 125.83-125.83 125.83z"
                      fill="#28A0F0"
                    />
                    <path
                      d="M141.73 31.8c-60.64 0-109.93 49.29-109.93 109.93s49.29 109.93 109.93 109.93 109.93-49.29 109.93-109.93S202.37 31.8 141.73 31.8z"
                      fill="#28A0F0"
                    />
                  </svg>
                </div>
